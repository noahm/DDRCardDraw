...
export function Footer() {
  return (
    <div className={classNames(styles.footer, globalStyles.padded)}>
      Songs up to date as of 11/16/2018. Report bugs via <a href="https://twitter.com/Cathadan" target="_blank">Twitter</a> or <a href="https://github.com/noahm/DDRCardDraw">GitHub</a>. <a href="#" onClick={showCredits}>Credits.</a>
    </div>
  );
}
